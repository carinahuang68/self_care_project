...
async function renderGallery() {
  ...
  for (const entry of sorted) {
    const items = await loadMedia(entry.id);
    ...
    card.innerHTML = `
      ...
      <div class="card-body">
        ...
        <div class="card-actions">
          ...
          <button type="button" class="btn-edit-entry">Edit Entry</button>
        </div>
      </div>
      <button class="card-delete" title="Delete entry">✕</button>
    `;
